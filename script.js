...
var repliesForGirlfriend = ["I don't have a girlfriend, find one for me please 🙏🥺 "];
...
function ifElseThinkAndExecute(textString) {
    if (textString.includes("hii") || textString.includes("hi") || textString.includes("hello") || textString.includes("hola") || textString.includes("hey")) {
        ...
        else if (textString.includes("your gf") || (textString.includes("your girlfriend") || textString.includes("your partner" || textString.includes("your love") || textString.includes("your lover")))) {
        // reply for 'who is your girlfriend' request
        sendTextMessage(repliesForGirlfriend);
    } else {
        setTimeout(() => {
